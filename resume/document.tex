...
\begin{itemize}
	\item Held workshops on computer graphics 
	\item Topics covered: \texttt{OpenGL}, rendering pipeline, transforms
\end{itemize}}
...
\begin{itemize}
	...
	\item \cvitem{\texttt{Python}}{Train reinforcement learning agents; Do plot drawing}
	\item \cvitem{\texttt{Pie}}{Dependent typed functional language as theorem prover}
\end{itemize}}
