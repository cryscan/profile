...
{Ann Arbor}
{GPA 3.9 out of 4.0}
{\cvitem{Core courses}{Computer Architecture, Data Structures and Algorithms, Operating Systems, Compiler Construction, Game Development}}
...
\cvitem{Programming Languages}{
	\begin{itemize}
		...
		\item \cvitem{\texttt{Python}}{Be able to implement machine learning algorithms and train agents}
	\end{itemize}}
\cvitem{Game Engines}{\texttt{Unity} (\texttt{C\#}), \texttt{Amethyst} (\texttt{Rust}), \texttt{Bevy} (\texttt{Rust})}
