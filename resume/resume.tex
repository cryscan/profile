...
\cventry{Feb. 2023 -- Present}
{Senior Graphics Engineer}
{Tencent Games}
{}{}
{
	MagicDawn: A distributed GPU-accelerated light baking system based on OptiX 7
	\begin{itemize}
		\item Developed a high-performance light baking solution serving over ten game projects including \textit{Roco Kingdom: World}
		\item Optimized baking performance and quality for large-scale open-world games
	\end{itemize}
}
...
{Programmer}
{Real-Time Global Illumination Plugin for Bevy}
{}{}
{
