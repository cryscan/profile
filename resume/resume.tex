...
{Ann Arbor}
{}
{\cvitem{Core courses}{Parallel Computing}}
...
\cvitem{Programming Languages}{
	\begin{itemize}
		...
		\item \cvitem{\texttt{Python}}{Implement learning algorithms}
	\end{itemize}}
\cvitem{Game Engines}{\texttt{Unity}, \texttt{Bevy} (\texttt{Rust} Game Engine)}
